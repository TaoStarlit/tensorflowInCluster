...
For illustration, we will show how to implement our own equivalent model to LinearRegressor 
...
Instead of sub-classing Estimator, we simply provide Estimator a function model_fn that tells tf.estimator 
