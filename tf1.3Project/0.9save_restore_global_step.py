...
start_checkpoint = savepara_dir + savepara_file + '-180'
...
if start_checkpoint:  # NameError: name 'start_checkpoint' is not defined
    ...
    print('restore the checkpoint:',start_checkpoint)
...
if not start_checkpoint:
    for i in range(200):
        ...
        if(i % 20 == 0):
            ...
            print("save the parameter!! in step", i)
            saver.save(sess, savepara_dir + savepara_file, global_step=i)
