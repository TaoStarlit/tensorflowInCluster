...
print("linear model node:",linear_model) # linear model node: Tensor("add:0", dtype=float32)
...
print("squared_delta,loss: ",squared_delta,loss) #(<tf.Tensor 'Square:0' shape=<unknown> dtype=float32>, <tf.Tensor 'Sum:0' shape=<unknown> dtype=float32>)
...
print(optimizer) #(<tensorflow.python.training.gradient_descent.GradientDescentOptimizer object at 0x2b9cb35cc9d0>, 
